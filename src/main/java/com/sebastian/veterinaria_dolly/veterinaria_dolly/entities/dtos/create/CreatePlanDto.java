...
public class CreatePlanDto {
    ...
    public @NotNull(message = "El valor de temporada baja del plan es requerido") @Positive(message = "El valor de temporada baja del plan debe ser positivo") @Min(value = 1, message = "El valor de temporada baja del plan mínimo vale 1") Float getLowSeasonPrice() {
        return lowSeasonPrice;
    }

    public void setLowSeasonPrice(@NotNull(message = "El valor de temporada baja del plan es requerido") @Positive(message = "El valor de temporada baja del plan debe ser positivo") @Min(value = 1, message = "El valor de temporada baja del plan mínimo vale 1") Float lowSeasonPrice) {
